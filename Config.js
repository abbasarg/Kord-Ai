...
global.settings = {
  OWNER_NUMBERS: "2349043883888", // your number with country code
  OWNER_NAME: 'Abbas_Cyber', // your owner name 
  BOT_NAME: "CYBER_BOT", // your preferred bot name
  SESSION_ID: 'kord_ai-y1QkXDH5JkYTQ0XA', // replace your_sessionid with yours and make sure its inside rhe quotes
  ...
  PREFIX: [".", "/", "!"],
  GROUP_EVENTS: true,
  WELCOME_MESSAGE: "Hello! I'm CYBER BOT, your friendly WhatsApp bot.",
  ...
  BANKING_DETAILS: {
    ...
    acc_number: "8104029966", // account number for your preferred bank
    acc_name: "Abbas Alhassan" // name of your bank
  },
